...
$(document).ready(function(){
	...
	let headerArea = $('.header__area');
	let mobileMenu = $('.mobile-menu');
	let headerPlace = $('.header__place');
	let menuLink = $('.menu__link');
	menuLink.click(function(){
		headerArea.removeClass('_active');
		headerBurger.removeClass('_active');
		mobileMenu.removeClass('_active');
		headerPlace.removeClass('_active');
		$('body').removeClass('_lock');
	});
	headerBurger.click(function(){
		$(this).toggleClass('_active');
		headerArea.toggleClass('_active');
		mobileMenu.toggleClass('_active');
		headerPlace.toggleClass('_active');
